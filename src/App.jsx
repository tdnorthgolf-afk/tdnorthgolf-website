...
const IMAGES = {
  logo: "/images/IMG_2155.JPG",
  hero: "/images/Facetune_12-12-2022-05-24-28.jpg",
  teaching: "/images/Facetune_12-12-2022-05-24-28.jpg",
  trophy1: "/images/IMG_6559.PNG",
  trophy2: "/images/IMG_1813.jpg",
  trophy3: "/images/IMG_2279.JPG",
  juniors: "/images/IMG_1573.JPG",
  juniorBoys: "/images/IMG_8883.jpg",
  course: "/images/IMG_8604.jpg",
  group: "/images/IMG_8546.jpg",
};
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            {/* Option 1: Direct Instagram embeds */}
            <a 
              href="https://www.instagram.com/tdnorthgolf/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="aspect-square bg-stone-100 flex items-center justify-center hover:bg-stone-200 transition-colors group"
            >
              <div className="text-center p-4">
                <svg className="w-12 h-12 mx-auto text-stone-400 group-hover:text-stone-600 mb-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-stone-600 font-medium">View on Instagram</p>
                <p className="text-stone-400 text-sm">@tdnorthgolf</p>
              </div>
            </a>
          </div>
